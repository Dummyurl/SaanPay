...
import com.saxxis.recharge.fragments.BanksListFragment;
import com.saxxis.recharge.fragments.ReqForPaymentFragment;
...
public class MoneyDepositActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        depositToolbar.setTitleTextColor(Color.parseColor("#053174"));
        depositToolbar.setNavigationIcon(R.drawable.ic_back);
