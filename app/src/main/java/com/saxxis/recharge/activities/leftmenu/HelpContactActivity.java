...
import com.saxxis.recharge.adapters.HelpAdapter;
...
import com.saxxis.recharge.models.Chat;
import com.saxxis.recharge.models.Help;
import com.saxxis.recharge.utils.ui.EndlessRecyclerOnScrollListener;
...
public class HelpContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.title_activity_help_contact);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            toolbar.setTitleTextColor(getResources().getColor(R.color.colorchange,HelpContactActivity.this.getTheme()));
        }else {
