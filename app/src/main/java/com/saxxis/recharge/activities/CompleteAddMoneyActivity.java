...
import static com.saxxis.recharge.R.string.userid;
...
public class CompleteAddMoneyActivity extends AppCompatActivity {
    ...
    @BindView(R.id.addmoney_creditpay)
    TextView payCredit;
    @BindView(R.id.addmoney_debitcard)
    TextView payDebit;
    @BindView(R.id.addmoney_netbanking)
    TextView payNetBanking;
