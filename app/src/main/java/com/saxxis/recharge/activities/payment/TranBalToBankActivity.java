package com.saxxis.recharge.activities.payment;
...
import com.saxxis.recharge.adapters.dropdown.BankListAdapter;
...
import com.saxxis.recharge.models.BeneficiaryDetails;
...
public class TranBalToBankActivity extends AppCompatActivity {
    ...
    @BindView(R.id.fee_txt)TextView txtFee;
    @BindView(R.id.netpayable_txt)TextView txtNetPayble;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setTitleTextColor(Color.parseColor("#053174"));
            ...
            public void onResponse(String s) {
                ...
                try{
                    ...
                    if(status.equals("ok")){
                        ...
                        int atomwalletremainingamountInt = 0;
                        if(atomwalletremainingamount!=null){
                            atomwalletremainingamountInt = Integer.parseInt(remainingwalletamount);
                        }
                        if(Integer.parseInt(finalmoney)<=atomwalletremainingamountInt){
                            submitPayment();
                        }else{
                            new AlertDialog.Builder(TranBalToBankActivity.this)
