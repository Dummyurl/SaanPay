 ...
 */
public class TranxListReceiveFragment extends Fragment {

    @BindView(R.id.receiverecv_wallettranx)
    RecyclerView recvOrders;

    @BindView(R.id.receivetrnxprogressbar)
    ProgressBar trnxProgressBar;

    private UserPref userPref;
    private ArrayList<WalletTranxs> mData;
    public static TranxListReceiveFragment newInstance() {

        return new TranxListReceiveFragment();
    }


    public TranxListReceiveFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_tranx_listrecvice, container, false);
    ...
    private  void fetchOrders() {
        ...
        String url= AppConstants.WALLET_TRNX+userPref.getUserId()+"&walletcatagory=1";
        Log.e("response",url);
