...
import com.saxxis.recharge.activities.leftmenu.AddressActivity;
import com.saxxis.recharge.activities.leftmenu.ChangePasswordActivity;
import com.saxxis.recharge.activities.leftmenu.HelpContactActivity;
import com.saxxis.recharge.activities.main.ForgotPassActivity;
import com.saxxis.recharge.activities.main.LoginActivity;
import com.saxxis.recharge.activities.main.MainActivity;
import com.saxxis.recharge.activities.main.SignupActivity;
...
import com.saxxis.recharge.helpers.PermissionHandler;
...
import static com.saxxis.recharge.app.AppConstants.SELECT_PROFILE_CAMERA;
import static com.saxxis.recharge.app.AppConstants.SELECT_PROFILE_PICTURE;
...
public class ProfileFragment extends Fragment implements NetworkListener {
    ...
    @BindView(R.id.perTv)
    TextView perTv;
    @BindView(R.id.perTvUpgrade)
    TextView perTvUpgrade;
    @BindView(R.id.usedTV)
    TextView usedTV;
    @BindView(R.id.maxTv)
    TextView maxTv;
    @BindView(R.id.upgradeLL)
...
//                AppHelper.Snackbar(getActivity(),flProfile,"Login Failed Please try Again", AppConstants.MESSAGE_COLOR_ERROR,AppConstants.TEXT_COLOR);
            ...
            public void onResponse(String s) {
                ...
                try{
                    ...
                    if(status.equals("ok")){
                        ...
                        perTv.setText("Your Limit "+amount);
                        usedTV.setText(""+walletamtInt);
                        maxTv.setText(""+amount);
                        if(usertype.equals("NonkycUser")){
                            upgradeLL.setVisibility(View.VISIBLE);
                        }else{
                            upgradeLL.setVisibility(View.GONE);
                        }
    ...
    void upgrade(){
        startActivity(new Intent(getActivity(), KYCUploadActivity.class));
    }
