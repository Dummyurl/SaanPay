 ...
 */
public class TranxPaidFragment extends Fragment {

    @BindView(R.id.paidrecv_wallettranx)
    RecyclerView recvOrders;

    @BindView(R.id.paidtrnxprogressbar)
    ProgressBar trnxProgressBar;

    private UserPref userPref;
    private ArrayList<WalletTranxs> mData;

    public static TranxPaidFragment newInstance() {

        return new TranxPaidFragment();
    }

    public TranxPaidFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_tranx_paid, container, false);
    ...
    private  void fetchOrders() {
        ...
        String url= AppConstants.WALLET_TRNX+userPref.getUserId()+"&walletcatagory=2";
        Log.e("response",url);
