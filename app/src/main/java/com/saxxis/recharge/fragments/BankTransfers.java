 ...
 * Use the {@link BankTransfers#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BankTransfers extends Fragment {
    ...
    public static BankTransfers newInstance() {
        BankTransfers fragment = new BankTransfers();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_bank_transfers, container, false);
    ...
    private  void fetchOrders() {
        ...
        String url = AppConstants.WALLET_TRNX+userPref.getUserId()+"&walletcatagory=6";
        Log.e("response",url);
