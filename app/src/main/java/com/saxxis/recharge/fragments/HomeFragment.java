...
import com.saxxis.recharge.activities.leftmenu.QRCodeActivity;
import com.saxxis.recharge.activities.main.LoginActivity;
import com.saxxis.recharge.activities.payment.AddMoneyActivity;
import com.saxxis.recharge.activities.payment.DepositTwoActivity;
import com.saxxis.recharge.activities.payment.PassBookActivity;
import com.saxxis.recharge.activities.recharge.DataCardActivity;
import com.saxxis.recharge.activities.recharge.DthActivity;
import com.saxxis.recharge.activities.recharge.MobileRechargePrepaidActivity;
import com.saxxis.recharge.activities.reservation.BusesActivity;
import com.saxxis.recharge.activities.reservation.FlightActivity;
import com.saxxis.recharge.activities.reservation.HolidayActivity;
import com.saxxis.recharge.activities.reservation.HotelsActivity;
import com.saxxis.recharge.activities.reservation.MoviesActivity;
import com.saxxis.recharge.activities.specialities.SpecialityListingActivity;
import com.saxxis.recharge.activities.utlity.ElectricityActivity;
import com.saxxis.recharge.activities.utlity.GasActivity;
import com.saxxis.recharge.activities.utlity.InsuranceActivity;
import com.saxxis.recharge.activities.utlity.WaterActivity;
import com.saxxis.recharge.adapters.CategoryAdapter;
import com.saxxis.recharge.adapters.CategoryAdapterFadedText;
                ...
                switch (position){
                    case 0:
                       startActivity(new Intent(getActivity(), MobileRechargePrepaidActivity.class).putExtra("checkoptiontype","1"));
                        ...
                        break;
                    case 1:
                       startActivity(new Intent(getActivity(), MobileRechargePrepaidActivity.class).putExtra("checkoptiontype","2"));
                        //Postpaid Activity
                        break;
                    case 2:
